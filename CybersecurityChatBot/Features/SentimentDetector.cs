...
public static class SentimentDetector
{
    ...
    /// Combines an empathy line with an automatic tip on the most relevant topic.
    ...
    /// <summary>
    /// Convenience method: detects sentiment and builds the full response in one call.
